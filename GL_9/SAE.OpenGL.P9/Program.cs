...
namespace SAE.GPR.P10
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Time.Initialize();
            Window.CreateWindow("OpenGL P10", 800, 600);
            ...
            Vector3[] colors = GenerateColors(Colors.White);
            Vector3[] normals = GenerateFlatNormals(vertices, indices);
        ...
        private static void SetTransform(GameObject obj)
        {
            ...
            obj.Transform.Rotation += new Vector3(30f * deltaTime, 30f * deltaTime, 30f * deltaTime);
            obj.Transform.Position = new Vector3(Mathf.Sin(Time.TimeSinceStart), Mathf.Sin(Time.TimeSinceStart), Mathf.Sin(Time.TimeSinceStart) - 10);

            Matrix4 view = GetViewMatrix();
            Matrix4 projection = GetProjectionMatrix();
            Matrix4 model = obj.Transform.GetTRS();
            ...
            Vector3 viewPosition = new Vector3(0, 0, 0);
            Vector3 ambientLightColor = new Vector3(1, 0, 0);
        ...
        private static Vector3[] GenerateFlatNormals(Vector3[] verts, uint[] tris)
        {
            ...
            for (int i = 0; i < tris.Length; i += 3)
            {
                ...
                flatNormals[tris[i]] = normal;
                flatNormals[tris[i + 1]] = normal;
                flatNormals[tris[i + 2]] = normal;
            }
